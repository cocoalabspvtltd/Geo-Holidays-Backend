...
namespace App\Http\Requests\AyuvedicPackages;

use Illuminate\Contracts\Validation\Validator;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Exceptions\HttpResponseException;

class AyurvedicStoreRequest extends FormRequest
{
    /**
    ...
    protected function store(): array
    {
         ...
         return [
            ...
            'description' => 'required|string|max:2000', // minimum length is 3 characters, maximum length is 255 characters
            'activity_details' => 'required|string|max:2000',
            'treatments' => 'required|string|min:3|max:255', // minimum length is 3 characters, maximum length is 255 characters
