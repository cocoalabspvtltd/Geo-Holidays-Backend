    ...
    <div class="content-body" style="min-height: 1092px;">
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active">Exclussive Offers</li>
                    <a href="{{ route('exclusive-offers.create') }}" class="btn btn-primary"
                                            ...
                                            <tbody>
                                                @forelse ($data as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('exclusive-offers.edit', ['exclusiveOffers' => $item->id]) }}"
                                                                    class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                        class="fas fa-pencil-alt"></i></a>
                                                                <a href="{{ route('exclusive-offers.destroy', ['exclusiveOffers' => $item->id]) }}"
