                                        ...
                                        <thead>
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example3"
                                                    ...
                                                    style="width: 600.75px;">Description</th>
                                                <th class="sorting" tabindex="0" aria-controls="example3"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Gender: activate to sort column ascending"
                                                    style="width: 77.6406px;">status</th>
                                                <th class="sorting" tabindex="0" aria-controls="example3"
                                                    rowspan="1" colspan="1"
                                        ...
                                        <tbody>
                                            @forelse ($data as $task)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{ route('category.edit',['packageCategory'=> $task->id]) }}"
                                                                class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                    class="fas fa-pencil-alt"></i></a>
                                                            <a href="{{ route('category.destroy',['packageCategory'=> $task->id]) }}"
