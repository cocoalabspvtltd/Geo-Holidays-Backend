    ...
    <div class="content-body" style="min-height: 1092px;">
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active">Why Book with Us</li>
                    <a href="{{ route('Why-book-with-us.create') }}" class="btn btn-primary"
            ...
            <div class="row page-titles">
                <ul class="breadcrumb">
                    ...
                    <a href="{{ route('why_book_us_banner.edit') }}" class="btn btn-primary"
                                            ...
                                            <tbody>
                                                @forelse ($data as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('Why-book-with-us.edit',['whyBookWithUS' => $item->id]) }}"
                                                                    class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                        class="fas fa-pencil-alt"></i></a>
                                                                <a href="{{ route('Why-book-with-us.destroy',['whyBookWithUS'=> $item->id]) }}"
