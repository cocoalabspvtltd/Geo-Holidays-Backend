                                            ...
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    <th class="sorting" tabindex="0" aria-controls="example3"
                                                        ...
                                                        style="width: 170.422px;">Address</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example3"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Department: activate to sort column ascending"
                                                        style="width: 203.75px;">Phone Number</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example3"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Gender: activate to sort column ascending"
                                                        style="width: 77.6406px;">Email</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example3"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Gender: activate to sort column ascending"
                                                        style="width: 77.6406px;">Location</th>
                                                    <th class="sorting" tabindex="0" aria-controls="example3"
                                                        rowspan="1" colspan="1"
                                            ...
                                            <tbody>
                                                @forelse ($data as $item)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="{{ route('contact-details.edit', ['contactDetails' => $item->id]) }}"
                                                                    class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                                        class="fas fa-pencil-alt"></i></a>
                                                                <a href="{{ route('contact-details.destroy', ['contactDetails' => $item->id]) }}"
